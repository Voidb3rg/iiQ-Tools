...
function get_hotel_email() {
  ...
  var hotel_email = $('#hotel_email', $('#stamm').contents()).val();
    (cr_email.length !=0) ? cr_email : ((hotel_email) ? hotel_email : 'Error')
}
...
function get_hotel_email() {
  ...
  return (cr_email.length != 0) ? cr_email : ((hotel_email) ? hotel_email : 'Error');
}
...
function get_hotel_email() {
  var cr_email = $('#hotel_contact_request_email', $('#stamm').contents()).val();
  var hotel_email = $('#hotel_email', $('#stamm').contents()).val();
  return (cr_email.length != 0) ? cr_email : ((hotel_email !== undefined) ? hotel_email : 'Error');
}
...
function inject_hidden_iframe(){
  ...
  if (hotelid !== null){
      $('<iframe id="stamm" style="display: none; width:1000px">').attr('src', '/admin/hotels/' + hotelid + '/edit').appendTo('body')
  }
}

// get hotel_email
function get_hotel_email() {
var cr_email = $('#stamm').contents().find('#hotel_contact_request_email').val();
var hotel_email = $('#hotel_email', $('#stamm').contents()).val();
...
txt3_str = $(get_hotel_email());   
txt3.innerHTML = txt3_str;
$(document).ready($("div.navbar-header").after(txt1, txt2, txt3))          // Insert new elements after <img>
}

var txt3 = document.createElement("b");
$(document).ready($("div.navbar-header").after(txt3.innerHTML = $(get_hotel_email())))
...
$('#stamm').on( 'load', function(){afterText()})
